...
TfLiteStatus FeatureProvider::PopulateFeatureData(
  ...
  //printf("\n INSIDE PopulateFeatureData \n");
  //printf("\n feature_size_=%d", feature_size_);
  //printf("\n kFeatureElementCount=%d", kFeatureElementCount);
  ...
  *how_many_new_slices = slices_needed;
  ...
  //printf("\n INSIDE PopulateFeatureData   -10  \n");
  //printf("\n INSIDE PopulateFeatureData   slices_needed=%d  \n", slices_needed);
